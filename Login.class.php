...
function authorize($logoff_callback = null) {
	...
	elseif(isset($_GET['action']) && $_GET['action'] == "clear_login" && isset($_SESSION[$this->prefix.'pass']) ){

		if ($logoff_callback != null)
		{
			call_user_func($logoff_callback);
		} 
